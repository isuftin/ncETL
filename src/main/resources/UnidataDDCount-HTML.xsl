...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:nc="http://www.unidata.ucar.edu/namespaces/netcdf/ncml-2.2">
	<xd:doc xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" scope="stylesheet">
		<xd:desc>
			<xd:p>
				<xd:b>Created on:</xd:b> August 20, 2010
			</xd:p>
			<xd:p>
				<xd:b>Author:</xd:b>ted.habermann@noaa.gov
			</xd:p>
			<xd:p>
				<xd:b>Modified by:</xd:b>jiwalker@usgs.gov
			</xd:p>
			<xd:p/>
		</xd:desc>
	</xd:doc>
	...
	<xsl:template match="/">
		...
		<html>
			...
			<div id="metaSummary" class="x-hidden">
				...
				<xsl:variable name="titleAttribute" select="/nc:netcdf/nc:attribute[@name='title']"/> The Unidata Attribute Convention for Data Discovery provides recommendations for netCDF attributes that can be added to netCDF files to
					facilitate discovery of those files using standard metadata searches. This tool tests conformance with those recommendations. More
				<a href="https://www.nosc.noaa.gov/dmc/swg/wiki/index.php?title=NetCDF_Attribute_Convention_for_Dataset_Discovery#Conformance_Test">Information on Convention and Tool</a>.
			
				<h2> Title:
					<xsl:value-of select="$titleAttribute/@value"/>
				</h2>
				<h2>Total Score:
					<xsl:value-of select="$spiralTotal"/>/
					<xsl:value-of select="$spiralMax"/>
				</h2>
			...
			<div id="identification" class="x-hidden">
				<h2>Identification / Metadata Reference Score:
					<xsl:value-of select="$identifierTotal"/>/
					<xsl:value-of select="$identifierMax"/>
				</h2>
				...
				<table id="identificationTab" width="95%" border="1" cellpadding="2" cellspacing="2">
					...
					<tr>
						...
						<td rowspan="2" valign="top">The combination of the "naming authority" and the "id" should be a globally unique identifier for the dataset.
							<br/>
						</td>
						<td valign="top">dataset@id
							<br/>
						</td>
					...
					<tr>
						...
						<td valign="top">This attribute provides a link to a complete metadata record for this dataset or the collection that contains this dataset.
							<i>This attribute is not included in Version 1 of the Unidata Attribute
			...
			<div id="textSearch" class="x-hidden">
				<h2>Text Search Score:
					<xsl:value-of select="$textSearchTotal"/>/
					<xsl:value-of select="$textSearchMax"/>
				</h2>
				...
				summary, might also be displayed in the results of text searches.
				</p>
				<table id="textSearchTab" width="95%" border="1" cellpadding="2" cellspacing="2">
					<tr>
						<th valign="top">Score</th>
						<th valign="top">Attribute</th>
						<th valign="top">Description</th>
					...
					<tr>
						...
						<td valign="top">A short description of the dataset.
							<br/>
						</td>
						<td valign="top">dataset@name
							<br/>
						</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:title/gco:CharacterString
							<br/>
						</td>
					</tr>
					<tr>
						...
						<td valign="top">A paragraph describing the dataset.
							<br/>
						</td>
						<td valign="top">metadata/documentation[@type="summary"]
							<br/>
						</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:abstract/gco:CharacterString
							<br/>
						</td>
					</tr>
					<tr>
						...
						<td valign="top">A comma separated list of key words and phrases.
							<br/>
						</td>
						<td valign="top">metadata/keyword
							<br/>
						</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:keyword/gco:CharacterString
							<br/>
						</td>
					</tr>
					<tr>
						...
						<td valign="top">If you are following a guideline for the words/phrases in your "keywords" attribute, put the name of that guideline here.
							<br/>
						</td>
					...
					<tr>
						...
						<td valign="top">The name of the controlled vocabulary from which variable standard names are taken.
							<br/>
						</td>
					...
					<tr>
						...
						<td valign="top">metadata/documentation
							<br/>
						</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:supplementalInformation
							<br/>
						</td>
					</tr>
				</table>
			...
			<div id="extentSearch" class="x-hidden">
				<h2>Extent Search Score:
					<xsl:value-of select="$extentTotal"/>/
				...
				the data if the file is compliant with the 
					<a href="http://cf-pcmdi.llnl.gov/">NetCDF Climate and Forecast (CF) Metadata Convention</a>.
				</p>
				<table id="extentSearchTab" width="95%" border="1" cellpadding="2" cellspacing="2">
					<tr>
						<th valign="top">Score</th>
						<th valign="top">Attribute</th>
						<th valign="top">Description</th>
					...
					<tr>
						...
						<td rowspan="13" colspan="1" valign="top">Describes a simple latitude, longitude, vertical and temporal bounding box. For a more detailed geospatial coverage, see the
							<a href="http://www.unidata.ucar.edu/software/netcdf-java/formats/DataDiscoveryAttConvention.html#suggested_geospatial">suggested geospatial attributes</a>.
							<br/> Further refinement of the geospatial bounding box can
						be provided by using these units and resolution attributes.
							<br/>
						</td>
						<td valign="top">metadata/geospatialCoverage/northsouth/start
							<br/>
						</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:extent/gmd:EX_Extent/gmd:geographicElement/gmd:EX_GeographicBoundingBox/gmd:southBoundLatitude/gco:Decimal
							<br/>
						</td>
					</tr>
					<tr>
						...
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:extent/gmd:EX_Extent/gmd:geographicElement/gmd:EX_GeographicBoundingBox/gmd:northBoundLatitude/gco:Decimal
							<br/>
						</td>
					</tr>
					<tr>
						...
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:extent/gmd:EX_Extent/gmd:geographicElement/gmd:EX_GeographicBoundingBox/gmd:westBoundLongitude/gco:Decimal
							<br/>
						</td>
					</tr>
					<tr>
						...
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:extent/gmd:EX_Extent/gmd:geographicElement/gmd:EX_GeographicBoundingBox/gmd:eastBoundLongitude/gco:Decimal
							<br/>
						</td>
					</tr>
					<tr>
			...
			<div id="otherExtentInformation" class="x-hidden">
				<h2>Other Extent Information Score:
					<xsl:value-of select="$otherExtentTotal"/>/
					<xsl:value-of select="$otherExtentMax"/>
				</h2>
				...
				<table id="otherExtentInformationTab" width="95%" border="1" cellpadding="2" cellspacing="2">
					<tr>
						<th valign="top">Score</th>
						<th valign="top">Attribute</th>
						<th valign="top">Description</th>
					...
					<tr>
						...
						<td valign="top">metadata/geospatialCoverage/updown/resolution
							<br/>
						</td>
					</tr>
					<tr>
						...
						<td valign="top">metadata/geospatialCoverage@zpositive
							<br/>
						</td>
					</tr>
					<tr>
						...
						compliant description of the time period covered by the dataset. This standard supports descriptions of 
							<a href="http://en.wikipedia.org/wiki/ISO_8601#Durations">durations</a>.
						</td>
					</tr>
					<tr>
						<xsl:call-template name="showScore">
			...
			<div id="creatorSearch" class="x-hidden">
				<h2>Creator Search Score:
					<xsl:value-of select="$creatorTotal"/>/
					<xsl:value-of select="$creatorMax"/>
				</h2>
				...
				<table id="creatorSearchTab" width="95%" border="1" cellpadding="2" cellspacing="2">
					<tr>
						<th valign="top">Score</th>
						<th valign="top">Attribute</th>
						<th valign="top">Description</th>
					...
					<tr>
						...
						<td rowspan="4" colspan="1" valign="top">The data creator's name, URL, and email. The "institution" attribute will be used if the "creator_name" attribute does not exist.
							<br/>
						</td>
						<td valign="top">metadata/creator/name
							<br/>
						</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/gmd:CI_ResponsibleParty/gmd:individualName/gco:CharacterString
							<br/>
					...
					<tr>
						...
						<td valign="top">metadata/creator/contact@url
							<br/>
						</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL
							<br/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td valign="top">The date on which the data was created.
							<br/>
						</td>
						<td valign="top">metadata/date[@type="created"]</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:date/gmd:CI_Date/gmd:date/gco:Date
							<br/> /gmd:dateType/gmd:CI_DateTypeCode="creation"
						</td>
					</tr>
					<tr>
						<xsl:call-template name="showScore">
						...
						<td valign="top">The date on which this data was last modified.
							<br/>
						</td>
						<td valign="top">metadata/date[@type="modified"]</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:date/gmd:CI_Date/gmd:date/gco:Date
							<br/> /gmd:dateType/gmd:CI_DateTypeCode="revision"
						</td>
					</tr>
					<tr>
						<xsl:call-template name="showScore">
						...
						<td valign="top">The date on which this data was formally issued.
							<br/>
						</td>
						<td valign="top">metadata/date[@type="issued"]</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:date/gmd:CI_Date/gmd:date/gco:Date
							<br/> /gmd:dateType/gmd:CI_DateTypeCode="publication"
						</td>
					</tr>
					<tr>
						<xsl:call-template name="showScore">
						...
						<td valign="top">The scientific project that produced the data.
							<br/>
						</td>
						<td valign="top">metadata/project
							<br/>
						</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:aggregationInfo/gmd:MD_AggregateInformation/gmd:aggregateDataSetName/gmd:CI_Citation/gmd:title/gco:CharacterString
							<br/>
					...
					<tr>
						...
						<td valign="top">A place to acknowledge various type of support for the project that produced this data.
							<br/>
						</td>
			...
			<div id="contributorSearch" class="x-hidden">
				<h2>Contributor Search Score:
					<xsl:value-of select="$contributorTotal"/>/
					<xsl:value-of select="$contributorMax"/>
				</h2>
				...
				<table id="contributorSearchTab" width="95%" border="1" cellpadding="2" cellspacing="2">
					<tr>
						<th valign="top">Score</th>
						<th valign="top">Attribute</th>
						<th valign="top">Description</th>
					...
					<tr>
						...
						<td rowspan="2" colspan="1" valign="top">The name and role of any individuals or institutions that contributed to the creation of this data.
							<br/>
						</td>
						<td valign="top">metadata/contributor
							<br/>
						</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/gmd:CI_ResponsibleParty/gmd:individualName/gco:CharacterString
							<br/>
					...
					<tr>
						...
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/gmd:CI_ResponsibleParty/gmd:role/gmd:CI_RoleCode
							<br/> ="principalInvestigator" |
						"author"
						</td>
					</tr>
				</table>
			...
			<div id="publisherSearch" class="x-hidden">
				<h2>Publisher Search Score:
					<xsl:value-of select="$publisherTotal"/>/
					<xsl:value-of select="$publisherMax"/>
				</h2>
				...
				<table id="publisherSearchTab" width="95%" border="1" cellpadding="2" cellspacing="2">
					<tr>
						<th valign="top">Score</th>
						<th valign="top">Attribute</th>
						<th valign="top">Description</th>
					...
					<tr>
						...
						<td valign="top">metadata/publisher/name
							<br/>
						</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/gmd:CI_ResponsibleParty/gmd:individualName/gco:CharacterString
							<br/>
					...
					<tr>
						...
						<td valign="top">metadata/publisher/contact@url
							<br/>
						</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL
							<br/>
					...
					<tr>
						...
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:address/gmd:CI_Address/gmd:electronicMailAddress/gco:CharacterString
							<br/>
						CI_RoleCode="publisher"
						</td>
					</tr>
			...
			<div id="otherAttributes" class="x-hidden">
				<h2>Other Attributes Score:
					<xsl:value-of select="$otherTotal"/>/
					<xsl:value-of select="$otherMax"/>
				</h2>
				<p>This group includes attributes that don't seem to fit in the other categories.</p>
				<table id="otherAttributesTab" width="95%" border="1" cellpadding="2" cellspacing="2">
					<tr>
						<th valign="top">Score</th>
						<th valign="top">Attribute</th>
						<th valign="top">Description</th>
					...
					<tr>
						...
						<td valign="top">A textual description of the processing (or quality control) level of the data.
							<br/>
						</td>
					...
					<tr>
						...
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:resourceConstraints/gmd:MD_LegalConstraints/gmd:useLimitation/gco:CharacterString
							<br/>
						</td>
					</tr>
					<tr>
						...
						<td valign="top">The
							<a href="http://www.unidata.ucar.edu/projects/THREDDS/tech/catalog/InvCatalogSpec.html#dataType">THREDDS data type</a> appropriate for this dataset.
						</td>
						<td valign="top">metadata/dataType</td>
						<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:spatialRepresentationType/gmd:MD_SpatialRepresentationTypeCode
							<br/> May need some extensions to this codelist. Current values:
			...
			<div id="rubricVersion" class="x-hidden">
				Rubric Version:
